...
```{r filter_droid, paged.print=FALSE}
filter(starwars, species == "Droid")
```


```{r filter_height_gt_220, paged.print=FALSE}
...
```{r starwars_select, paged.print=FALSE}
...
humans_avg_bmi_by_homeworld <- 
  summarize(humans_bmi_by_homeworld, avg_bmi = mean(bmi))
