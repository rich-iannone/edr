...
```{r plot_legend_right}
ggplot(dmd, aes(x = carats, y = price)) +
  geom_point(aes(color = cut, shape = clarity)) +
  labs(color = "Cut", shape = "Clarity") +
...
ggplot(dmd_mod, aes(x = carats, y = price)) +
  geom_point(aes(color = quality, shape = price_class)) +
  facet_wrap(facets = vars(price_class, quality)) +
  labs(color = "Overall Quality", shape = "Price per Carat") +
